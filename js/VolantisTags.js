...
// img/avatar.gif
var bamao = '<i  id="upj"  class="fas fa-arrow-up" style ="padding:8px" ></i><img style="max-width: 234%;transform: translate(-65px,-65px);" src="https://gitee.com/cnnc/pic-go-picture-bed/raw/master/img/Sitich/Sitich05.gif" title="回到顶部" data-ll-status="loaded" class="loaded">';
/*添加到返回顶部按钮下*/
